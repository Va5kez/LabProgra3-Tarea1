...
SDL_Event Event;
SDL_Texture *background,*character,*character1;
SDL_Rect rect_background,rect_character,rect_character1;
...
int main( int argc, char* args[] )
{
    ...
    character1 = IMG_LoadTexture(renderer, "hola.png");
    SDL_QueryTexture(character1, NULL, NULL, &w, &h);
    rect_character1.x = 50; rect_character1.y = 50; rect_character1.w = w; rect_character1.h = h;
    ...
    while(true)
    {
        ...
        SDL_RenderCopy(renderer, character1, NULL, &rect_character1);
